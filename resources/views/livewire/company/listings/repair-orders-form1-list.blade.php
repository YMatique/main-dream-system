                    ...
                    <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                        <thead class="bg-gray-50 dark:bg-gray-700">
                            <tr>
                                ...
                                <th wire:click="sortBy('form1.client.name')" class="px-6 py-4 text-left text-xs font-bold text-gray-600 dark:text-gray-300 uppercase tracking-wider cursor-pointer hover:bg-gray-100 dark:hover:bg-gray-600 transition-all duration-200">
                                    Cliente @if ($sortField === 'form1.client.name') {{ $sortDirection === 'asc' ? '↑' : '↓' }} @endif
                                </th>
                                <th wire:click="sortBy('form1.maintenanceType.name')" class="px-6 py-4 text-left text-xs font-bold text-gray-600 dark:text-gray-300 uppercase tracking-wider cursor-pointer hover:bg-gray-100 dark:hover:bg-gray-600 transition-all duration-200">
                                    Tipo Manutenção @if ($sortField === 'form1.maintenanceType.name') {{ $sortDirection === 'asc' ? '↑' : '↓' }} @endif
                                </th>
                                <th wire:click="sortBy('form1.machineNumber.number')" class="px-6 py-4 text-left text-xs font-bold text-gray-600 dark:text-gray-300 uppercase tracking-wider cursor-pointer hover:bg-gray-100 dark:hover:bg-gray-600 transition-all duration-200">
                                    Máquina @if ($sortField === 'form1.machineNumber.number') {{ $sortDirection === 'asc' ? '↑' : '↓' }} @endif
                                </th>
                                <th wire:click="sortBy('form1.carimbo')" class="px-6 py-4 text-left text-xs font-bold text-gray-600 dark:text-gray-300 uppercase tracking-wider cursor-pointer hover:bg-gray-100 dark:hover:bg-gray-600 transition-all duration-200">
                                    Data @if ($sortField === 'form1.carimbo') {{ $sortDirection === 'asc' ? '↑' : '↓' }} @endif
                                </th>
                                <th class="px-6 py-4 text-left text-xs font-bold text-gray-600 dark:text-gray-300 uppercase tracking-wider">Descrição Avaria</th>
                        ...
                        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-md border border-gray-200 dark:border-gray-700 p-6 transition-all duration-300 hover:shadow-lg">
                            ...
                            <div class="space-y-3 mb-4">
                                <div class="flex justify-between">
                                    ...
                                    <span class="text-sm font-bold text-gray-900 dark:text-white">{{ $order->form1?->client?->name ?? '-' }}</span>
                                </div>
                                <div class="flex justify-between">
                                    <span class="text-sm text-gray-600 dark:text-gray-400">Tipo Manutenção:</span>
                                    <span class="text-sm font-bold text-gray-900 dark:text-white">{{ $order->form1?->maintenanceType?->name ?? '-' }}</span>
                                </div>
                                <div class="flex justify-between">
                                    <span class="text-sm text-gray-600 dark:text-gray-400">Máquina:</span>
                                    <span class="text-sm font-bold text-gray-900 dark:text-white">{{ $order->form1?->machineNumber?->number ?? '-' }}</span>
                                </div>
                                <div class="flex justify-between">
                                    <span class="text-sm text-gray-600 dark:text-gray-400">Descrição:</span>
                                    <span class="text-sm font-bold text-gray-900 dark:text-white">{{ Str::limit($order->form1?->descricao_avaria ?? '-', 30) }}</span>
                                </div>
                            </div>
