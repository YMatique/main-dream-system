    ...
    <div class="bg-gradient-to-r from-purple-600 via-blue-600 to-indigo-700 rounded-xl shadow-lg p-6 text-white">
        ...
        <div class="mt-6">
            <div class="flex items-center justify-between mb-2">
                ...
                <span class="text-sm text-purple-100">3 de 5</span>
            </div>
        ...
        @if ($repairOrder && $this->orderSummary)
            ...
            <div class="mt-6 grid grid-cols-1 md:grid-cols-2 gap-4">
                <div class="bg-white/10 backdrop-blur-sm rounded-lg p-4">
                    <div class="text-sm text-purple-100">Número de Máquina</div>
                    <div class="text-xl font-bold">{{ $repairOrder->form1?->machineNumber?->number ?? 'N/A' }}</div>
                </div>
                <div class="bg-white/10 backdrop-blur-sm rounded-lg p-4">
                    <div class="text-sm text-purple-100">Descrição de Avaria</div>
            ...
            <div>
                    ...
                    <select wire:model.live="selectedOrderId"
                        ...
                        @foreach ($availableOrders as $order)
                            <option value="{{ $order->id }}">
                                ...
                                (Máquina: {{ $order->form1?->machineNumber?->number ?? 'N/A' }} -
                ...
                @if (count($availableOrders) === 0)
                    <div class="mt-3 text-center py-4">
                        ...
                        <p class="text-gray-500 text-sm">Nenhuma ordem disponível. Complete o Formulário de Técnicos e
                            Materiais.</p>
    ...
    @if ($selectedOrderId && $repairOrder)
        <form wire:submit="save" class="space-y-6">
            ...
            @if ($repairOrder && $repairOrder->form1)
                <div
                    class="bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-gray-800 dark:to-gray-700 rounded-xl shadow-lg border border-blue-200 dark:border-gray-600 overflow-hidden">
                    <div class="px-6 py-4 border-b border-blue-200 dark:border-gray-600">
                        <div class="flex items-center justify-between">
                            <div class="flex items-center">
                                ...
                                <div class="ml-4">
                                    <h3 class="text-lg font-semibold text-gray-900 dark:text-white">Informações da
                                        Máquina</h3>
                                    <p class="text-sm text-gray-600 dark:text-gray-400">Dados carregados
                                        automaticamente do Form 1</p>
                                </div>
                            </div>
                ...
                <div class="p-6">
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <div class="relative">
                                <input type="text" value="{{ $this->machineNumber }}" readonly
            ...
            @if ($repairOrder && $this->orderSummary)
                <div
                    class="bg-gradient-to-r from-gray-50 to-blue-50 dark:from-gray-800 dark:to-gray-700 rounded-xl shadow-lg border border-gray-200 dark:border-gray-600 overflow-hidden">
                    <div class="px-6 py-4 border-b border-gray-200 dark:border-gray-600">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4">
                                ...
                                <p class="text-sm text-gray-600 dark:text-gray-400">Histórico de progresso nos
                                    formulários anteriores</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="p-6">
                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                            ...
                            <div class="bg-white dark:bg-gray-800 rounded-lg p-4 shadow-sm border-l-4 border-blue-500">
                                ...
                                <div class="space-y-1 text-xs text-gray-600 dark:text-gray-400">
                                    <div>Cliente: <span
                                            class="font-medium">{{ Str::limit($this->orderSummary['client'], 15) }}</span>
                                    </div>
                                    <div>Tipo: <span
                                            class="font-medium">{{ Str::limit($this->orderSummary['maintenance_type'], 15) }}</span>
                                    </div>
                                    <div>Máquina: <span
                                            class="font-medium text-blue-600">{{ $this->orderSummary['machine_number'] }}</span>
                                    </div>
                                </div>
                            </div>
                            ...
                            {{-- Formulário 2 --}}
                            <div
                                class="bg-white dark:bg-gray-800 rounded-lg p-4 shadow-sm border-l-4 border-green-500">
                                <div class="flex items-center justify-between mb-2">
                                ...
                                <div class="space-y-1 text-xs text-gray-600 dark:text-gray-400">
                                    ...
                                    <div class="text-lg font-bold text-green-600">
                                        {{ number_format($this->orderSummary['worked_hours'], 1) }}h</div>
                                </div>
                            </div>

                            {{-- Formulário 3 --}}
                            <div
                                class="bg-white dark:bg-gray-800 rounded-lg p-4 shadow-sm border-l-4 border-orange-500">
                                <div class="flex items-center justify-between mb-2">
                                    <h4 class="text-sm font-medium text-orange-600 dark:text-orange-400">Form 3
                                        (Próximo)</h4>
                                ...
                                <div class="space-y-1 text-xs text-gray-600 dark:text-gray-400">
                                    ...
                                    <div class="text-lg font-bold text-orange-600">
                                        {{ number_format($this->orderSummary['billed_hours'], 1) }}h</div>
                                </div>
                            </div>

                            {{-- Formulário 4 (Atual) --}}
                            <div
                                class="bg-white dark:bg-gray-800 rounded-lg p-4 shadow-sm border-l-4 border-purple-500">
                                <div class="flex items-center justify-between mb-2">
                                ...
                                <div class="space-y-1 text-xs text-gray-600 dark:text-gray-400">
                                    <div>Status: <span
                                            class="font-medium text-purple-600">{{ $isEditing ? 'Editando' : 'Novo' }}</span>
                                    </div>
                        ...
                        <div class="mt-4 p-4 bg-white dark:bg-gray-800 rounded-lg shadow-sm">
                            <h4 class="text-sm font-medium text-gray-900 dark:text-white mb-2">Descrição da Avaria:
                            </h4>
                            <p class="text-sm text-gray-600 dark:text-gray-400 italic">
                                {{ $this->orderSummary['description'] }}</p>
                        </div>
                    </div>
                </div>
            @endif
                ...
                <div class="flex flex-col sm:flex-row items-center justify-between gap-4">
                    ...
                    <div class="flex flex-col sm:flex-row gap-3 w-full sm:w-auto">
                        ...
                        @if ($repairOrder && $repairOrder->form4)
                            <a href="{{ route('company.repair-orders.form3', $repairOrder->id) }}"
                                ...
                                <span class="mr-2">Prosseguir para Faturação Real</span>
                ...
                @if (!$this->machineNumber || $this->machineNumber === 'N/A')
                    <div class="mt-4 text-center">
                        <p class="text-sm text-red-600 dark:text-red-400">
                            ...
                            <a href="{{ route('company.repair-orders.form1', $repairOrder->id) }}"
                                class="text-blue-600 hover:text-blue-800 underline ml-1">
                                Editar Formulário de Dados Iniciais
                            </a>
                        </p>
                    </div>
                @endif
    ...
    @else
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg border border-gray-200 dark:border-gray-700 p-12">
            <div class="text-center">
                ...
                <h3 class="text-lg font-medium text-gray-900 dark:text-white mb-2">Selecione uma ordem para processar
                </h3>
                <p class="text-gray-600 dark:text-gray-400 mb-6">
                    Para registrar a máquina no Formulário 4, selecione uma ordem de reparação que já possui faturação
                    concluída (Técnicos e Materiais).
                </p>
