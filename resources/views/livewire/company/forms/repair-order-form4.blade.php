            ...
            <div>
                ...
                @if(count($availableOrders) === 0)
                    <div class="mt-3 text-center py-4">
                        ...
                        <p class="text-gray-500 text-sm">Nenhuma ordem disponível. Complete o Formulário de Técnicos e Materiais.</p>
                ...
                <div class="p-6">
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                        ...
                        <div class="bg-white dark:bg-gray-800 rounded-lg p-4 shadow-sm border-l-4 border-orange-500">
                            <div class="flex items-center justify-between mb-2">
                                <h4 class="text-sm font-medium text-orange-600 dark:text-orange-400">Form 3 (Próximo)</h4>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg border border-gray-200 dark:border-gray-700 p-12">
            <div class="text-center">
                ...
                <p class="text-gray-600 dark:text-gray-400 mb-6">
                    Para registrar a máquina no Formulário 4, selecione uma ordem de reparação que já possui faturação concluída (Técnicos e Materiais).
                </p>
