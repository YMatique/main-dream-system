        ...
        @if ($repairOrder && $repairOrder->form1)
            <div class="mt-6 grid grid-cols-1 md:grid-cols-4 gap-4">
                ...
                <div class="bg-white/10 backdrop-blur-sm rounded-lg p-4">
                    ...
                    <div class="text-xl font-bold">{{ number_format($repairOrder->form2?->tempo_total_horas ?? 0, 1) }}h
                    </div>
                </div>
                <div class="bg-white/10 backdrop-blur-sm rounded-lg p-4">
        ...
        <div
            ...
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    ...
                    <p class="text-sm text-gray-600 dark:text-gray-400">Escolha a ordem com trabalho concluído para
                        faturar</p>
                </div>
            </div>
        </div>
            ...
            <div>
                    ...
                    <select wire:model.live="selectedOrderId"
                        ...
                        @foreach ($availableOrders as $order)
                            <option value="{{ $order->id }}">
                                ...
                                ({{ number_format($order->form2?->tempo_total_horas ?? 0, 1) }}h -
                ...
                @if (count($availableOrders) === 0)
                    <div class="mt-3 text-center py-4">
                        ...
                        <p class="text-gray-500 text-sm">Nenhuma ordem disponível. Complete o Formulário 2 primeiro.
                        </p>
                ...
                <div class="p-6">
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <div class="relative">
                                <input type="date" wire:model="data_faturacao" max="{{ date('Y-m-d') }}"
                    ...
                    <div class="flex items-center justify-between">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4">
                                ...
                                <p class="text-sm text-gray-600 dark:text-gray-400">Comparação entre horas trabalhadas
                                    e faturadas</p>
                            </div>
                        </div>
                        ...
                        @if ($repairOrder && $repairOrder->form2)
                            <div class="text-right">
                                ...
                                <div class="text-2xl font-bold text-gray-800 dark:text-white">
                                    {{ number_format($repairOrder->form2->tempo_total_horas, 1) }}h</div>
                            </div>
                        @endif
                    </div>
                </div>
                    ...
                    <div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div class="relative">
                                <input type="number" step="0.25" min="0" max="999.99"
                                    wire:model="horas_faturadas" placeholder="0.00"
                            ...
                            @if ($repairOrder && $repairOrder->form2 && $horas_faturadas)
                                <div class="flex items-center space-x-4 text-sm">
                                    <div class="text-center p-3 bg-gray-50 dark:bg-gray-700 rounded-lg">
                                        ...
                                        <div
                                            class="font-bold {{ $horas_faturadas - $repairOrder->form2->tempo_total_horas > 0 ? 'text-green-600' : 'text-red-600' }}">
                                            {{ number_format($horas_faturadas - $repairOrder->form2->tempo_total_horas, 1) }}h
                                        </div>
                                    </div>
                                    <div class="text-center p-3 bg-blue-50 dark:bg-blue-900/20 rounded-lg">
                                        <div class="text-blue-600 dark:text-blue-400 text-xs">Custo Estimado</div>
                        ...
                        @if ($repairOrder && $repairOrder->form2)
                            <div class="mt-3 text-sm text-gray-600 dark:text-gray-400">
                                ...
                                Foram trabalhadas {{ number_format($repairOrder->form2->tempo_total_horas, 1) }} horas
                                no total.
                            </div>
                        @endif
                    </div>
                ...
                <div
                    ...
                    <div class="flex items-center justify-between">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4">
                                <h3 class="text-lg font-semibold text-gray-900 dark:text-white">Materiais Faturados
                                </h3>
                                <p class="text-sm text-gray-600 dark:text-gray-400">Materiais a serem incluídos na
                                    faturação</p>
                            </div>
                        </div>
                                        ...
                                        <div class="mt-3">
                                            ...
                                            @if (isset($materiaisDisponiveis[$material->id]) && $materiaisDisponiveis[$material->id]['quantidade'] > 0)
                                                <div class="mt-2 text-xs text-orange-600 font-medium">
                                                    Custo:
                                                    {{ number_format($material->cost_per_unit_mzn * $materiaisDisponiveis[$material->id]['quantidade'], 2) }}
                                                    MZN
                                                </div>
                                            @endif
            ...
            <div
                ...
                <div class="p-6">
                    <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
                        ...
                        <div
                            class="text-center p-4 bg-white dark:bg-gray-800 rounded-lg shadow-sm border-2 border-indigo-200">
                            <div class="text-3xl font-bold text-indigo-600 dark:text-indigo-400">
                                {{ number_format($this->totalEstimatedCost, 2) }}</div>
                            <div class="text-sm text-indigo-600 dark:text-indigo-400 mt-1 font-medium">TOTAL (MZN)
                            </div>
                        </div>
                    </div>
                </div>
    ...
    @else
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg border border-gray-200 dark:border-gray-700 p-12">
            <div class="text-center">
                ...
                <h3 class="text-lg font-medium text-gray-900 dark:text-white mb-2">Selecione uma ordem para faturar
                </h3>
                <p class="text-gray-600 dark:text-gray-400 mb-6">
                    Para gerar a faturação real, selecione uma ordem de reparação que já possui o trabalho técnico
                    concluído (Formulário 2).
                </p>
