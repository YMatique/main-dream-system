<div class="space-y-6">
    ...
    <div class="bg-gradient-to-r from-teal-500 via-blue-600 to-indigo-700 rounded-xl shadow-lg p-6 text-white">
        <div class="flex flex-col lg:flex-row justify-between items-start lg:items-center">
            <div>
                ...
                <p class="mt-2 text-teal-100">Gerencie os tipos de manutenção da sua empresa</p>
            </div>
    ...
    <div class="sticky top-0 z-10 bg-white dark:bg-gray-800 rounded-t-xl shadow border border-gray-200 dark:border-gray-700 p-4 flex flex-col sm:flex-row justify-between items-center gap-4">
        <div class="flex items-center gap-2">
            ...
            <button wire:click="archiveUnused"
                class="inline-flex items-center px-4 py-2 bg-white dark:bg-gray-700 text-gray-700 dark:text-gray-300 border border-gray-300 dark:border-gray-600 rounded-lg hover:bg-teal-50 dark:hover:bg-teal-900/20 transition-colors"
                title="Arquivar tipos de manutenção inativos sem ordens ativas">
                <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        ...
                        <tr class="hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors">
                            ...
                            <td class="px-6 py-4">
                                <div class="text-sm text-gray-500 dark:text-gray-400">
                                    {{ Str::limit($type->description, 50, '...') ?: 'N/A' }}</div>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap">
                                @if ($type->active_orders_count > 0)
                                    <span
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                <div class="flex items-center justify-end space-x-2">
                                    ...
                                    <button wire:click="confirmDelete({{ $type->id }})"
                                        class="text-red-600 hover:text-red-900 dark:text-red-400 dark:hover:text-red-300 transition-colors {{ $type->active_orders_count > 0 ? 'opacity-50 cursor-not-allowed' : '' }}"
                                        title="{{ $type->active_orders_count > 0 ? 'Não pode ser eliminado devido a ordens ativas' : 'Eliminar' }}"
                                        {{ $type->active_orders_count > 0 ? 'disabled' : '' }}>
                                        <svg class="w-5 h-5" fill="none" stroke="currentColor"
                                            viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        ...
                        <tr>
                            <td colspan="5" class="px-6 py-12 text-center">
                                <div class="flex flex-col items-center">
                                    ...
                                    <p class="text-gray-500 dark:text-gray-400 mb-4">Comece criando o seu primeiro tipo de manutenção.</p>
                                    <button wire:click="openModal"
