        ...
        <div class="mt-6 grid grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <div class="bg-white/10 backdrop-blur-sm rounded-lg p-4">
                <div class="flex items-center">
                    ...
                    <div class="ml-3">
                        <p class="text-2xl font-bold">{{ number_format($this->stats['avg_hourly_rate_mzn'], 2) }} MZN</p>
                            ...
                            <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full">
                                ...
                                <div class="mt-4">
                                    <form wire:submit.prevent="save" class="space-y-4">
                                        ...
                                        <div>
                                            <label for="hourly_rate_mzn" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Taxa Horária Padrão (MZN)</label>
                                            <input wire:model.live="hourly_rate_mzn" id="hourly_rate_mzn" type="number" step="0.01" min="0"
                                            ...
                                            @error('hourly_rate_mzn') <span class="text-sm text-red-600 dark:text-red-400">{{ $message }}</span> @enderror
                                        </div>
                                        <div>
                                            <label for="hourly_rate_usd" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Taxa Horária Padrão (USD)</label>
                                            <input wire:model.live="hourly_rate_usd" id="hourly_rate_usd" type="number" step="0.01" min="0"
                                                ...
                                                placeholder="Ex: 7.80">
                                            @error('hourly_rate_usd') <span class="text-sm text-red-600 dark:text-red-400">{{ $message }}</span> @enderror
                                        </div>
                                        <div>
