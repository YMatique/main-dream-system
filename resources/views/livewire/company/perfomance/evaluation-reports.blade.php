                ...
                <div class="flex items-center gap-4 mt-6 lg:mt-0">
                    ...
                    <div class="relative" x-data="{ open: false }">
                        ...
                        <div x-show="open" @click.away="open = false"
                            ...
                            <div class="py-2">
                                <button wire:click="$set('exportFormat', 'xlsx'); exportReport()" @click="open = false"
                                ...
                                <button wire:click="$set('exportFormat', 'csv'); exportReport()" @click="open = false"
                                    class="block w-full text-left px-4 py-3 text-sm text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors">
                                    📄 CSV (.csv)
                                </button>
                                <button wire:click="$set('exportFormat', 'pdf'); exportReport()" @click="open = false"
                                    class="block w-full text-left px-4 py-3 text-sm text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors">
                                    📋 PDF (.pdf)
                                </button>
                            </div>
        ...
        <div class="p-6">
            ...
            <div class="border-t border-gray-200 dark:border-gray-700 pt-6">
                <button wire:click="toggleAdvancedFilters"
                    ...
                    <svg class="w-4 h-4 transition-transform duration-200 {{ $showAdvancedFilters ? 'rotate-90' : '' }}"
                        fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path>
                    </svg>
                    <span>{{ $showAdvancedFilters ? 'Ocultar Filtros' : 'Mostrar Filtros Avançados' }}</span>
                </button>
                ...
                @if ($showAdvancedFilters)
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 pb-4">
                        ...
                        <div class="space-y-2">
                            <label
                                class="block text-sm font-medium text-gray-700 dark:text-gray-300">Funcionário</label>
                        ...
                        <div class="space-y-2">
                            <label
                                class="block text-sm font-medium text-gray-700 dark:text-gray-300">Performance</label>
        ...
        @if ($activeTab === 'overview')
            <div class="space-y-6">
                            ...
                            <div>
                                ...
                                <div class="mt-2">
                                    <span class="text-xs bg-green-400 text-white px-2 py-1 rounded-full">
                                        {{ ($stats['total_evaluations'] ?? 0) > 0 ? round((($stats['approved_evaluations'] ?? 0) / ($stats['total_evaluations'] ?? 1)) * 100, 1) : 0 }}%
                                        do total
                                    </span>
                                </div>
                            </div>
                        ...
                        <div class="flex items-center justify-between">
                            <div>
                                ...
                                @if (($stats['pending_evaluations'] ?? 0) > 0)
                                    <div class="mt-2">
                                        <span
                                            class="text-xs bg-yellow-400 text-white px-2 py-1 rounded-full animate-pulse">
                                            Requer atenção
                                        </span>
                                    </div>
                                @endif
                            ...
                            <div>
                                ...
                                <div class="mt-2">
                                    @if (($stats['average_performance'] ?? 0) >= 80)
                                        <span
                                            class="text-xs bg-green-400 text-white px-2 py-1 rounded-full">Excelente</span>
                                    ...
                                    @elseif(($stats['average_performance'] ?? 0) >= 50)
                                        <span
                                            class="text-xs bg-yellow-400 text-white px-2 py-1 rounded-full">Regular</span>
                                    @else
                                        <span
                                            class="text-xs bg-red-400 text-white px-2 py-1 rounded-full">Crítico</span>
                                    @endif
                                </div>
                            </div>
                            <div class="w-12 h-12 bg-white/20 rounded-lg flex items-center justify-center">
                ...
                @if (isset($chartData['performance_chart']))
                    <div
                        class="bg-white dark:bg-gray-800 shadow-xl rounded-2xl p-6 border border-gray-200 dark:border-gray-700">
                        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-6">
                            <h3 class="text-lg font-semibold text-gray-900 dark:text-white">Distribuição de Performance
                            </h3>
                ...
                @if (isset($reportData['department_performance']) && $reportData['department_performance']->count() > 0)
                    <div
                        ...
                        <div class="px-6 py-4 border-b border-gray-200 dark:border-gray-700">
                            <h3 class="text-lg font-semibold text-gray-900 dark:text-white">Performance por
                                Departamento</h3>
                        </div>
                                        ...
                                        <tr class="hover:bg-gray-50 dark:hover:bg-gray-700 cursor-pointer transition-colors"
                                            ...
                                            <td
                                                ...
                                                <div class="flex items-center">
                                                    <span
                                                        class="mr-2 font-semibold">{{ number_format($dept['average_performance'], 1) }}%</span>
                                            ...
                                            <td
                                                ...
                                                @else
                                                    <span
                                                        class="text-green-600 dark:text-green-400 font-medium">0</span>
                                                @endif
                                            </td>
                                        </tr>
                                    @endforeach
                                ...
                                <div wire:click="filterByDepartment('{{ $dept['department'] }}')"
                                    ...
                                    <div class="grid grid-cols-2 gap-3 text-sm">
                                        ...
                                        <div class="text-gray-600 dark:text-gray-400">
                                            ...
                                            @if ($dept['below_threshold'] > 0)
                                                <span
                                                    class="text-red-600 dark:text-red-400 font-medium">{{ $dept['below_threshold'] }}</span>
                                            @else
        ...
        @elseif($activeTab === 'performance')
            <div class="space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
                    <div
                        class="bg-white dark:bg-gray-800 overflow-hidden shadow-lg rounded-xl p-6 border border-gray-200 dark:border-gray-700">
                        <div class="flex items-center">
                                    ...
                                    @foreach ($reportData['top_performers'] as $index => $evaluation)
                                        <tr class="hover:bg-gray-50 dark:hover:bg-gray-700">
                                            <td
                                                ...
                                                @else
                                                    <span
                                                        class="inline-flex items-center justify-center w-8 h-8 rounded-full bg-blue-100 text-blue-800 dark:bg-blue-900/30 dark:text-blue-300 font-bold">
                                                        {{ $index + 1 }}
                                                    </span>
                                                @endif
                                            </td>
                                    ...
                                    @foreach ($reportData['departments'] as $dept)
                                        <tr class="hover:bg-gray-50 dark:hover:bg-gray-700">
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap text-sm">
                                                <div class="flex items-center">
                                                    <span
                                                        class="text-lg font-bold mr-2 text-gray-900 dark:text-white">{{ $dept['average_performance'] }}%</span>
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap text-sm">
                                                <div class="flex flex-wrap gap-1">
                                                    <span
                                                        class="px-2 py-1 text-xs bg-green-100 text-green-800 dark:bg-green-900/30 dark:text-green-300 rounded-full">E:
                                                        {{ $dept['excellent_count'] }}</span>
                                                    <span
                                                        class="px-2 py-1 text-xs bg-blue-100 text-blue-800 dark:bg-blue-900/30 dark:text-blue-300 rounded-full">B:
                                                        {{ $dept['good_count'] }}</span>
                                                    <span
                                                        class="px-2 py-1 text-xs bg-yellow-100 text-yellow-800 dark:bg-yellow-900/30 dark:text-yellow-300 rounded-full">S:
                                                        {{ $dept['satisfactory_count'] }}</span>
                                                    <span
                                                        class="px-2 py-1 text-xs bg-red-100 text-red-800 dark:bg-red-900/30 dark:text-red-300 rounded-full">P:
            ...
            <div class="space-y-6">
                @if (isset($reportData['message']))
                    <div
                        ...
                        <h3 class="text-lg font-medium text-gray-900 dark:text-white mb-2">Selecione um Funcionário
                        </h3>
                ...
                @elseif(isset($reportData['employee']))
                    ...
                    <div
                        ...
                        <div class="flex flex-col sm:flex-row items-start sm:items-center gap-6">
                            <div
                                class="w-20 h-20 bg-gradient-to-br from-blue-500 to-purple-600 rounded-xl flex items-center justify-center flex-shrink-0">
                                <span
                                    class="text-white text-2xl font-bold">{{ substr($reportData['employee']->name, 0, 2) }}</span>
                            </div>
                            <div class="flex-1">
                                ...
                                <p class="text-sm text-gray-400 dark:text-gray-500 mt-1">Código:
                                    {{ $reportData['employee']->code }}</p>
                            </div>
                                    ...
                                    <tbody
                                        ...
                                        @foreach ($reportData['evaluations'] as $evaluation)
                                            <tr class="hover:bg-gray-50 dark:hover:bg-gray-700">
                                                ...
                                                <td class="px-6 py-4 whitespace-nowrap text-sm">
                                                    <span
                                                        class="text-lg font-bold text-gray-900 dark:text-white">{{ $evaluation->final_percentage }}%</span>
                                                </td>
                                                <td class="px-6 py-4 whitespace-nowrap text-sm">
                                                    @if ($evaluation->final_percentage >= 90)
                                                        <span
            ...
            <div class="space-y-6">
                                    ...
                                    @foreach ($reportData['monthly_trends'] as $trend)
                                        <tr class="hover:bg-gray-50 dark:hover:bg-gray-700">
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap text-sm">
                                                <div class="flex items-center">
                                                    <span
                                                        class="mr-2 font-semibold text-gray-900 dark:text-white">{{ $trend['avg_performance'] }}%</span>
                                                    <div class="w-16 bg-gray-200 dark:bg-gray-700 rounded-full h-2">
                                                        <div class="bg-blue-600 h-2 rounded-full transition-all duration-300"
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap text-sm">
                                                <span
                                                    class="font-semibold {{ $trend['below_threshold_percentage'] > 20 ? 'text-red-600 dark:text-red-400' : ($trend['below_threshold_percentage'] > 10 ? 'text-yellow-600 dark:text-yellow-400' : 'text-green-600 dark:text-green-400') }}">
                ...
                @else
                    <div
                        ...
                        <h3 class="text-lg font-medium text-gray-900 dark:text-white mb-2">Nenhuma tendência encontrada
                        </h3>
                        <p class="text-gray-500 dark:text-gray-400">Não há dados suficientes para gerar tendências no
