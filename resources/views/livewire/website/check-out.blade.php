                            ...
                            <div class="col-lg-5 col-md-5 col-sm-12 col-xs-12">
                                ...
                                <div class="shop-order-box">
                                    ...
                                    <div class="place-order">
                                                ...
                                                <li>
                                                    <div class="radio-option">
                                                        ...
                                                        <label for="payment-1"><strong>Cheque Payment</strong>
                                                        	<span class="small-text">Please send your cheque to Store Name, Store Street, Store Town, Store State / County, Store Postcode.</span>
                                                        </label>
                                                    </div>
                                                </li>
                                        ...
                                        <button type="button" class="theme-btn btn-style-four">Order Place</button>
