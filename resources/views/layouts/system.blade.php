...
<!DOCTYPE html>
<html lang="pt" x-data="{ darkMode: localStorage.getItem('darkMode') === 'true' || false, sidebarOpen: false }" 
    ...
    <div class="min-h-screen flex">
        ...
        <div class="fixed inset-y-0 left-0 z-50 w-64 bg-white dark:bg-zinc-800 shadow-lg transform transition-transform duration-300 ease-in-out lg:translate-x-0 lg:static lg:inset-0"
            ...
            <div class="flex items-center justify-between h-16 px-6 border-b border-zinc-200 dark:border-zinc-700">
                ...
                <!-- Close button (mobile) -->
                <button @click="sidebarOpen = false" class="lg:hidden p-2 rounded-md text-zinc-500 hover:text-zinc-600 dark:text-zinc-400 dark:hover:text-zinc-300">
            ...
            <nav class="flex-1 px-4 py-6 space-y-1">
                ...
                <a href="{{ route('system.dashboard') }}" 
                   class="group flex items-center px-3 py-2 text-sm font-medium rounded-lg transition-all duration-200
                    ...
                    <svg class="mr-3 w-5 h-5 {{ request()->routeIs('system.dashboard') ? 'text-blue-500' : 'text-zinc-400 group-hover:text-zinc-500' }}" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 7v10a2 2 0 002 2h14a2 2 0 002-2V9a2 2 0 00-2-2H5a2 2 0 00-2-2z"></path>
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 5a2 2 0 012-2h2a2 2 0 012 2v0"></path>
                    </svg>
                    Dashboard
                </a>
                ...
                <a href="{{ route('system.companies') }}" 
                   class="group flex items-center px-3 py-2 text-sm font-medium rounded-lg transition-all duration-200
                          {{ request()->routeIs('system.companies*') 
                             ? 'bg-blue-50 dark:bg-blue-900/50 text-blue-700 dark:text-blue-300 border-r-2 border-blue-500' 
                             : 'text-zinc-700 dark:text-zinc-300 hover:bg-zinc-100 dark:hover:bg-zinc-700 hover:text-zinc-900 dark:hover:text-white' }}">
                    <svg class="mr-3 w-5 h-5 {{ request()->routeIs('system.companies*') ? 'text-blue-500' : 'text-zinc-400 group-hover:text-zinc-500' }}" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4"></path>
                    </svg>
                    Empresas
                </a>
                ...
                <a href="{{ route('system.plans') }}" 
                   class="group flex items-center px-3 py-2 text-sm font-medium rounded-lg transition-all duration-200
                          {{ request()->routeIs('system.plans*') 
                             ? 'bg-blue-50 dark:bg-blue-900/50 text-blue-700 dark:text-blue-300 border-r-2 border-blue-500' 
                             : 'text-zinc-700 dark:text-zinc-300 hover:bg-zinc-100 dark:hover:bg-zinc-700 hover:text-zinc-900 dark:hover:text-white' }}">
                    <svg class="mr-3 w-5 h-5 {{ request()->routeIs('system.plans*') ? 'text-blue-500' : 'text-zinc-400 group-hover:text-zinc-500' }}" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="{{ route('system.subscriptions') }}" 
                   class="group flex items-center px-3 py-2 text-sm font-medium rounded-lg transition-all duration-200
                          {{ request()->routeIs('system.subscriptions*') 
                             ? 'bg-blue-50 dark:bg-blue-900/50 text-blue-700 dark:text-blue-300 border-r-2 border-blue-500' 
                             : 'text-zinc-700 dark:text-zinc-300 hover:bg-zinc-100 dark:hover:bg-zinc-700 hover:text-zinc-900 dark:hover:text-white' }}">
                    <svg class="mr-3 w-5 h-5 {{ request()->routeIs('system.subscriptions*') ? 'text-blue-500' : 'text-zinc-400 group-hover:text-zinc-500' }}" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="{{ route('system.users') }}" 
                   class="group flex items-center px-3 py-2 text-sm font-medium rounded-lg transition-all duration-200
                          {{ request()->routeIs('system.users*') 
                             ? 'bg-blue-50 dark:bg-blue-900/50 text-blue-700 dark:text-blue-300 border-r-2 border-blue-500' 
                             : 'text-zinc-700 dark:text-zinc-300 hover:bg-zinc-100 dark:hover:bg-zinc-700 hover:text-zinc-900 dark:hover:text-white' }}">
                    <svg class="mr-3 w-5 h-5 {{ request()->routeIs('system.users*') ? 'text-blue-500' : 'text-zinc-400 group-hover:text-zinc-500' }}" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="{{ route('system.logs') }}" 
                   class="group flex items-center px-3 py-2 text-sm font-medium rounded-lg transition-all duration-200
                          {{ request()->routeIs('system.logs*') 
                             ? 'bg-blue-50 dark:bg-blue-900/50 text-blue-700 dark:text-blue-300 border-r-2 border-blue-500' 
                             : 'text-zinc-700 dark:text-zinc-300 hover:bg-zinc-100 dark:hover:bg-zinc-700 hover:text-zinc-900 dark:hover:text-white' }}">
                    <svg class="mr-3 w-5 h-5 {{ request()->routeIs('system.logs*') ? 'text-blue-500' : 'text-zinc-400 group-hover:text-zinc-500' }}" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"></path>
                    </svg>
                    Logs
                </a>
                ...
                <!-- Settings Section -->
                <div class="space-y-1">
                    <h3 class="px-3 text-xs font-semibold text-zinc-500 dark:text-zinc-400 uppercase tracking-wider">Sistema</h3>
                    
                    <a href="#" class="group flex items-center px-3 py-2 text-sm font-medium rounded-lg text-zinc-700 dark:text-zinc-300 hover:bg-zinc-100 dark:hover:bg-zinc-700 hover:text-zinc-900 dark:hover:text-white transition-all duration-200">
                        <svg class="mr-3 w-5 h-5 text-zinc-400 group-hover:text-zinc-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div x-show="sidebarOpen" 
             ...
             class="fixed inset-0 z-40 bg-zinc-600 bg-opacity-75 lg:hidden"
             style="display: none;"></div>

        <!-- Main content -->
        <div class="flex-1 flex flex-col ">
            <!-- Top bar -->
            <div class="sticky top-0 z-10 bg-white dark:bg-zinc-800 shadow-sm border-b border-zinc-200 dark:border-zinc-700">
                <div class="flex items-center justify-between h-16 px-4 sm:px-6 lg:px-8">
                    ...
                    <div class="flex items-center space-x-4">
                        ...
                        <!-- Notifications -->
                        <button class="p-2 rounded-md text-zinc-500 hover:text-zinc-600 dark:text-zinc-400 dark:hover:text-zinc-300 hover:bg-zinc-100 dark:hover:bg-zinc-700 relative">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <main class="flex-1 overflow-y-auto">
                <div class="p-4 sm:p-6 lg:p-8">
                    ...
                    @if (session()->has('message'))
                        <div class="mb-6 bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 text-green-800 dark:text-green-200 px-4 py-3 rounded-lg" role="alert">
                            <div class="flex items-center">
                    ...
                    @if (session()->has('error'))
                        <div class="mb-6 bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 text-red-800 dark:text-red-200 px-4 py-3 rounded-lg" role="alert">
                            <div class="flex items-center">
                                <svg class="w-5 h-5 mr-2" fill="currentColor" viewBox="0 0 20 20">
