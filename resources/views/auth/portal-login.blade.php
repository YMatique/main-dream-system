...
<head>
    ...
    <title>Login - Portal do Funcionário</title>
        ...
        <div class="max-w-md w-full space-y-8">
            ...
            <div class="text-center">
                ...
                <p class="mt-2 text-sm text-gray-600 dark:text-gray-400">
                    Acesse suas avaliações e histórico de desempenho
                </p>
            </div>
            ...
            <div class="text-center">
                <p class="text-xs text-gray-500 dark:text-gray-400">
                    ...
                    <a href="mailto:suporte@empresa.com" class="text-blue-600 hover:text-blue-500 dark:text-blue-400">
                        Entre em contato com o suporte
                    </a>
                </p>
                <p class="mt-2 text-xs text-gray-400 dark:text-gray-500">
                    &copy; {{ date('Y') }} {{ config('app.name') }}. Portal do Funcionário v1.0
                </p>
            </div>
        </div>
    </div>
